...
function showFirstAndLast (array){
    ...
    array.forEach(function(value){
        ...
        flArray.push(value[0]+ value[value.length-1])
    })
    return flArray;
}
...
function vowelCount (String){
    ...
    let splString = lowerCaseString.split('');
    
    splString.forEach(function (char){
...
function removeVowels (string){
    ...
    let splitedString = lowerCaseChar.split(''); 
    return splitedString.filter(function (char){
